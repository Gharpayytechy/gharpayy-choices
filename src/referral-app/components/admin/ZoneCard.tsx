...
export function ZoneCard({ stat }: { stat: ZoneStat }) {
  ...
  return (
    <Link
      ...
      className="group block rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 hover:border-blue-700/50 transition shadow-lg"
    >
      ...
      <div className="p-3 space-y-2">
        <div className="grid grid-cols-3 gap-1.5 text-center">
          ...
          <div className="rounded-lg bg-blue-700/10 py-1.5 border border-blue-700/20">
            <div className="text-base font-black text-sky-400 leading-none">{stat.conversion}%</div>
